...
| Score                  | 7.83/10                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Verdict                | ITERATE — band 6–7.9: iterate on the identified gaps. TL ruled 5 at iteration 4 — Value 3.50 stands, the cut question is closed. The v4 violation census reproduced exactly; prescriptions 4 and 5 closed (`verify:workflow` green by the scorer's execution). Remaining were five precision pieces — helper-breach deny in both directions, the predicate-stated legal count, exact reader taxonomy, the split-resolve/mixed-shape deny, Memory Input corrections — all applied same-session per the changelog; awaits iteration 5 |
| Iteration              | 4                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| Self-scored            | no                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Date                   | 2026-07-29 (iterations 2–4); iteration 1 on 2026-07-28                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
