...
| FR-4                  | `pnpm verify:workflow`                                             | repo     | passed | PASS with both new members live | the prompts check inside the bundle                                               |
...
| 2026-07-29 | 3.1 | captured generated set (30 paths): .provegate/** 21 files (prompts×13 incl. PLACEHOLDERS+README... templates×7, adapters×2, snippet), .claude/commands/prd-{1..7}.md, .cursor/rules/prd-workflow.mdc — the rollback deletion manifest |
