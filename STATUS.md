...
| Next candidates | PRD-017 substrate — **Phase 4 in flight** (lease held, 0/58). Wave order is now fixed: 017 → 018 (PASS 8.43) → 019 (PASS 8.985) → 021 (PASS 8.43, 0/82) → 020 (PASS 8.5, 0/58). PRD-021 gained a PRD-018 dependency because PRD-018 creates the root `workflow.config.json`; PRD-020 still waits on PRD-019 Ship Verified |
