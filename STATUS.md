...
| Next candidates | PRD-017 substrate — **Phase 4 in flight** (lease held, 0/58). Every other PRD is Phase 3 complete: 018 (8.33, 0/73) → 019 (8.985, 0/63) → 021 (8.43, 0/82) → 020 (8.5, 0/58), in that order. PRD-022 (control-artifact revalidation) is Approved at **PASS 9.10**, Phase 2 done, Phase 3 pending; it lands after PRD-018 because they share `method.mdx` |
