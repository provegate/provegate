...
- [one checkout one session](learnings/one-checkout-one-session.md) — two sessions in one working tree interleave HEAD; commits land on the other's branch — use worktrees
