...
2b. **Declare before you write.** The record's exact path must appear in the work item's
   ...
   allowed; removing or retyping one is weakening, and is compared against the work item
   as committed on the base branch.
