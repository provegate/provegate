...
claims "shipped + verified" _before any gate ran_ — inverting the gate order the whole
workflow depends on.

**Why:** the terminal status must be the _output_ of the gates, never a self-declared input;
