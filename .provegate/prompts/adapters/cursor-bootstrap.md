...
4. AGENT_BOOTSTRAP.md and AGENT_BOOTSTRAP.md
...
```markdown
You are the Phase 4 implementing agent for PRD-XXX.
...
pnpm check-types && pnpm lint → scoped tests → update the task file → repeat.
...
Phase 7 (knowledge), then `gate run PRD-XXX` for the mechanical close. Push
