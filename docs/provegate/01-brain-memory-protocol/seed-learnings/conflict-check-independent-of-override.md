...
reads *that* override, a caller can pass a narrow/false surface, pass the check, then mirror
...
The override may set the lock's recorded surface, but the *gate* reads the declaration. And
